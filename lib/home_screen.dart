...
//               children: [
//                 _buildFeatureCard(Icons.confirmation_number, 'Bus Ticket'),
//                 _buildFeatureCard(Icons.account_box, 'Daily Pass'),
//               ],
//             ),
//             SizedBox(height: 20),
...
//               mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//               children: [
//                 _buildFeatureCard(Icons.receipt, 'View Ticket'),
//                 _buildFeatureCard(Icons.card_membership, 'View Pass'),
//                 _buildFeatureCard(Icons.route, 'Route Timetable'),
//                 _buildFeatureCard(Icons.directions_subway, 'Metro Ticket'),
//               ],
//             ),
//             SizedBox(height: 20),
//             // Nearby Bus Stop
...
// // }
//
// import 'package:flutter/material.dart'; // Import the new form screen
// import 'map_screen.dart';
//
// class HomeScreen extends StatelessWidget {
//   const HomeScreen({Key? key}) : super(key: key);
...
//                       context,
//                       MaterialPageRoute(
//                         builder: (context) => BusPassFormScreen(),
//                       ),
//                     );
//                   },
//                 ),
...
//                     context,
//                     MaterialPageRoute(
//                       builder: (context) => DailyPassScreen(),
//                     ),
//                   );
//                 },
//                 ),
//                 _buildFeatureCard(Icons.account_box, 'Monthly Pass', () {
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                       builder: (context) => MonthlyPassScreen(),
//                     ),
//                   );
//                 },
//                 ),
...
//                     context,
//                     MaterialPageRoute(
//                       builder: (context) => ViewTicketScreen(ticketDetails: 'no details yet ',),
//                     ),
//                   );
//                 },
//                 ),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildFeatureCard(context, Icons.card_membership, tr.translate('view_pass'), () {}),
                _buildFeatureCard(context, Icons.route, tr.translate('route_timetable'), () {}),
