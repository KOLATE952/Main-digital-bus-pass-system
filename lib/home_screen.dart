...
//   late VoiceAssistant voiceAssistant;
//
//   @override
//   void initState() {
//     super.initState();
...
//           const BottomNavigationBarItem(icon: Icon(Icons.directions_bus), label: 'Buses'),
...
import 'profile_screen.dart';
import 'Bus Ticket/bus_pass_form.dart';
import 'voice_assistant/voice_assistant.dart'; // ✅ Ensure correct path and file
                ...
                _buildFeatureCard(
                  ...
                  tr.translate('view_pass'),
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ViewPassScreen()),
                    );
                  },
                ),
                _buildFeatureCard(
                  ...
                  tr.translate('route_timetable'),
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RouteTimetableScreen()),
                    );
                  },
                ),
              ],
