...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _checkPassExpiryAndNotify() async {
    try {
      // Assuming this method returns a notification message string or null if no notification needed
      ...
      if (notificationMessage != null && notificationMessage.isNotEmpty) {
        // Show Snackbar popup with the notification message
        if (mounted) {
        ...
        // Optionally trigger FIAM event here if needed
