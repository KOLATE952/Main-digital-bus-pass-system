...
// import 'package:flutter/services.dart'; // for rootBundle to load asset image
...
//     final file = File('${downloadsDir.path}/BusPass_${passData['passType']}_$formattedDate.pdf');
...
//   }
//
//   // Use Android external storage Downloads folder, else fallback to app documents
//   Future<Directory?> getDownloadsDirectory() async {
//     if (Platform.isAndroid) {
...
//       }
//     } else if (Platform.isIOS) {
//       // iOS doesn't allow access to external storage like Android
//       return await getApplicationDocumentsDirectory();
//     }
//     return null;
//   }
